...
},{}],"src/javascript/swipter.js":[function(require,module,exports) {
"use strict";
...
function Swipter(node) {
  ...
  this.root.ontouchstart = function (e) {
    _this.initX = e.changedTouches[0].pageX;
  };

  this.root.ontouchmove = function (e) {
    if (_this.clock) clearInterval(_this.clock);
    _this.clock = setTimeout(function () {
      _this.newX = e.changedTouches[0].pageX;

      if (_this.newX - _this.initX > 10) {
        _this.eventHub['swipRight'].forEach(function (fn) {
          return fn.bind(_this.root)();
        });
      } else if (_this.initX - _this.newX > 10) {
        _this.eventHub['swipLeft'].forEach(function (fn) {
          return fn.bind(_this.root)();
        });
      }
    }, 100);
  ...
  this.on = function (type, fn) {
    if (_this.eventHub[type]) {
      _this.eventHub[type].push(fn);
    }
  };
}

var _default = Swipter;
...
var _swipter = _interopRequireDefault(require("./swipter"));
...
player.prototype = {
  ...
  bind: function bind() {
    ...
    this.$playPre.on('click', function () {
      _this2.setButtonPlay();

      _this2.musicIndex--;

      if (_this2.musicIndex === -1) {
        _this2.musicIndex = _this2.musicList.length - 1;
      }

      _this2.audio.src = _this2.musicList[_this2.musicIndex].url;
    ...
    this.$areaBar.find('.bar').on('click', function (e) {
      var percent = e.offsetX / _this2.$areaBar.find('.bar').width();

      _this2.audio.currentTime = _this2.audio.duration * percent;

      _this2.updateStatus();
    });
    this.swipter = new _swipter.default(this.$panel[0]);
    this.swipter.on('swipLeft', function () {
      _this2.$panel.addClass('panel2').removeClass('panel1');

      _this2.$ball.eq(1).addClass('current').siblings().removeClass('current');
    });
    this.swipter.on('swipRight', function () {
      _this2.$panel.addClass('panel1').removeClass('panel2');

      _this2.$ball.eq(0).addClass('current').siblings().removeClass('current');
    });
  },
  ...
  setMusic: function setMusic() {
    ...
    this.audio.onloadedmetadata = function () {
      ...
      _this3.$player.find('.time-end').text(min + ':' + sec);
    };
  },
  setLyric: function setLyric() {
    var html = '';
  ...
  setButtonPlay: function setButtonPlay() {
    //解决点击下一曲或上一曲时，还处于暂停状态的bug
  ...
  start: function start() {
    ...
    this.ajax('https://Lazzben.github.io/data-mock/huawei-music/music-list.json').then(function (ret) {
      ...
      console.log(_this4.audio);
      console.log(_this4.musicList);
    }).catch(function () {
  ...
  getLyrics: function getLyrics() {
    ...
    this.ajax(this.musicList[this.musicIndex].lyric).then(function (ret) {
...
},{"./icons.js":"src/javascript/icons.js","./swipter":"src/javascript/swipter.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
